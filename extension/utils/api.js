...
var FPApi = {
  ...
  auth: {
    register: function (data) {
      return FPApi.post("/api/auth/register", data);
    },
    login: function (data) {
      return FPApi.post("/api/auth/login", data);
    },
    logout: function () {
      return FPApi.post("/api/auth/logout", {});
    },
    getMe: function () {
      return FPApi.get("/api/auth/me");
    },
    updateMe: function (data) {
      return FPApi.put("/api/auth/me", data);
    },
    changePassword: function (data) {
      return FPApi.put("/api/auth/change-password", data);
    },
  },

  profiles: {
    list: function () {
      return FPApi.get("/api/profiles");
    },
    get: function (id) {
      return FPApi.get("/api/profiles/" + id);
    },
    create: function (data) {
      return FPApi.post("/api/profiles", data);
    },
    update: function (id, data) {
      return FPApi.put("/api/profiles/" + id, data);
    },
    delete: function (id) {
      return FPApi.delete("/api/profiles/" + id);
    },
    duplicate: function (id) {
      return FPApi.post("/api/profiles/" + id + "/duplicate", {});
    },
    setDefault: function (id) {
      return FPApi.put("/api/profiles/" + id + "/set-default", {});
    },
  },

  ai: {
    generateAnswers: function (data) {
      return FPApi.post("/api/ai/generate-answers", data);
    },
    parseResume: function (data) {
      return FPApi.post("/api/ai/parse-resume", data);
    },
    getUsage: function () {
      return FPApi.get("/api/ai/usage");
    },
  },
  ...
  forms: {
    ...
    getAnalytics: function () {
      return FPApi.get("/api/forms/analytics");
    },
    save: function (data) {
      return FPApi.post("/api/forms/history", data);
    },
    delete: function (id) {
      return FPApi.delete("/api/forms/history/" + id);
    },
    clearAll: function () {
      return FPApi.delete("/api/forms/history");
    },
  },
};
